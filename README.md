...
-  Drivers designed and implemented for the project:
     ...
     Drivers are implemented using configuration technique "Static and Dynamic" to support different modes in Atmega32. Different design methods are used like interrupts, call backs, tight and periodic polling.
